...
class Settings(BaseSettings):
    ...
    EVENT_PEDESTRIAN_INTRUSION_ENABLED: bool = Field(default=True, env="EVENT_PEDESTRIAN_INTRUSION_ENABLED")
    EVENT_PEDESTRIAN_INTRUSION_COOLDOWN: int = Field(default=60, env="EVENT_PEDESTRIAN_INTRUSION_COOLDOWN")
    EVENT_PEDESTRIAN_INTRUSION_STAY_SECONDS: float = Field(default=2.0, env="EVENT_PEDESTRIAN_INTRUSION_STAY_SECONDS")
    EVENT_PEDESTRIAN_INTRUSION_DEFAULT_LEVEL: int = Field(default=3, env="EVENT_PEDESTRIAN_INTRUSION_DEFAULT_LEVEL")
